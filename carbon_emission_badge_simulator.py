...
# Function to award a badge based on total emissions
def award_badge(total_emission):
    if total_emission < 50:
        return "🌟 Eco Warrior Badge!"
    elif total_emission < 100:
        return "🌿 Green Living Badge!"
    else:
        return "🚶‍♂️ Step-Up Badge!"
...
def what_if_simulator(
    ...
    # Award a badge based on emissions
    badge = award_badge(total_emission)
    print(f"🏅 Badge: {badge}")
